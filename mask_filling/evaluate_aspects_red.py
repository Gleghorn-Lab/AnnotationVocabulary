...
def get_args():
    ...
    parser.add_argument('--at_path', type=str, default = 'GleghornLab/AT_RED')
    parser.add_argument('--asm35_path', type=str, default = 'GleghornLab/asm35_red')
    parser.add_argument('--data_path', type=str, default = 'GleghornLab/RED_annotations')
    parser.add_argument('--log_path', type=str, default='RED_fill.txt')
...
def main():
    ...
    models = {
        'at_red': {'path': args.at_path, 'type': 'AT'},
        'asm35_red': {'path': args.asm35_path, 'type': 'ASM'}
    }
